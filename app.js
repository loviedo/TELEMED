...
app.use('/estudios', estudios)//gestion de estudios
app.use('/consultas', consultas)//gestion de estudios
...
app.listen(3000, function(){
    console.log('Server iniciado en el puerto 3000: http://127.0.0.1:3000')
})